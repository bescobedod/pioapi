...
export const DevolucionCreateDto = yup
  .object({
    ...
    nombre_empresa: yup
      .string()
      .required("El [nombre_empresa] es un campo obligatorio."),
    nombre_tienda: yup
      .string()
      .required("El [nombre_tienda] es un campo obligatorio."),
    detalle: yup.string().required("El [detalle] es un campo obligatorio."),
    idEntradaInventario: yup
      .number()
      .required("El [idEntradaInventario] es un campo obligatorio."),
      ...
      .transform((value, originalValue) => {
        ...
        if (typeof originalValue === "string") {
          try {
            ...
            throw new yup.ValidationError(
              "[detalle_devolucion] debe ser un JSON válido.",
            );
          }
        }
        ...
        if (Array.isArray(originalValue)) {
          try {
            ...
            throw new yup.ValidationError(
              "[detalle_devolucion] contiene JSON inválido.",
            );
          }
        }
        return value;
...
export type DetalleDevolucionType =
  DevolucionCreateDtoType["detalle_devolucion"];
